...
export default function NativeHomePage() {
  ...
  return (
    <div className="bg-hd-background text-hd-on-surface">
      ...
      <main className="pt-16 pb-24">
        ...
        <section className="relative px-6 pt-20 pb-16 overflow-hidden -mt-16">
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-extrabold font-headline leading-tight tracking-tight mb-3">
              일할 준비 됐으면,
              <br />
        ...
        <section className="mb-16">
          <div className="px-6 flex justify-between items-end mb-6">
            <div>
              <h3 className="text-lg font-extrabold font-headline mb-1">
                지금 바로 지원 가능한 공고
              </h3>
        ...
        <section className="bg-hd-surface-container-low py-16 px-6">
          <div>
            <h3 className="text-2xl font-extrabold font-headline mb-10 text-center italic">
        ...
        <section className="py-16 px-6">
          <h3 className="text-xl font-bold font-headline mb-8 text-center text-hd-on-surface-variant">
            숫자로 증명하는 신뢰
          </h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 bg-hd-primary text-hd-on-primary p-8 rounded-[2rem] text-center shadow-xl shadow-hd-primary/10">
              <div className="text-4xl font-black font-headline mb-2 tracking-tighter">
                12,000+
              </div>
            ...
            <div className="bg-hd-surface-container-lowest p-6 rounded-3xl text-center border border-hd-surface-container">
              <div className="text-2xl font-black font-headline mb-1 text-hd-primary">
                200+
              </div>
        ...
        <section className="px-6 py-12 mb-8">
          <div className="relative bg-hd-inverse-surface text-hd-inverse-on-surface rounded-[2.5rem] p-10 overflow-hidden">
            <div className="relative z-10">
              <h3 className="text-xl font-extrabold font-headline mb-4 leading-tight">
                인력이 필요한 사장님을
                <br />
                위한 맞춤 솔루션
              </h3>
      ...
      {/* Footer */}
      <footer className="bg-slate-100 w-full py-12 px-6 pb-40">
        <div className="flex flex-col gap-8 w-full">
          <div className="flex flex-col gap-4">
            <span className="text-lg font-bold text-hd-primary tracking-tighter font-headline">
              HUMAN:D
            </span>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/terms" className="text-xs text-slate-500 active:text-hd-primary transition-colors">
              이용약관
            </Link>
            <Link href="/privacy" className="text-xs text-slate-500 active:text-hd-primary transition-colors">
              개인정보처리방침
            </Link>
            <a href="tel:02-875-8332" className="text-xs text-slate-500 active:text-hd-primary transition-colors">
              제휴문의
            </a>
          </div>
          <p className="text-[10px] text-slate-400 mt-4">
            &copy; 2024 HUMAN:D Staffing Platform. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
