...
export default function AppDownloadButtons() {
  ...
  return (
    <section className="bg-white px-6 py-2.5 my-8">
      <h3 className="text-base font-extrabold text-hd-on-surface my-[10pt]">
        휴멘드앱을 설치하고 편하게 일하세요!
      </h3>
      <div className="grid grid-cols-2 gap-2">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-white border border-gray-200 px-2 py-2 active:scale-95 transition-transform shadow-sm"
        >
          ...
          <div className="text-left">
            <div className="text-[7px] text-gray-500 leading-tight">GET IT ON</div>
            <div className="font-bold text-[10px] text-gray-900 leading-tight">Google Play</div>
          </div>
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 rounded-xl bg-black px-2 py-2 active:scale-95 transition-transform shadow-sm"
        >
          ...
          <div className="text-left">
            <div className="text-[7px] text-white/70 leading-tight">Download on the</div>
            <div className="font-bold text-[10px] text-white leading-tight">App Store</div>
          </div>
        </a>
      </div>
    </section>
