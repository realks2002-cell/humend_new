...
import { getClientDetail } from "@/lib/native-api/queries";
import type { ClientWithJobs } from "@/lib/native-api/queries";
import { formatDate, formatClientWage } from "@/lib/utils/format";
import {
  MapPin,
  Clock,
  Shirt,
...
export default function JobDetailClient() {
  ...
  return (
    <div className="mx-auto max-w-[57.6rem] px-4 pt-20 pb-8">
      ...
      <div className="mt-6">
        ...
        {data.job_postings.length === 0 ? (
          <p className="py-8 text-center text-sm text-muted-foreground">현재 모집 중인 일정이 없습니다.</p>
        ) : (
